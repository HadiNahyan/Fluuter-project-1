  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      drawer: Drawer(
          ...
          children: [
            DrawerHeader(
                ...
                child: Stack(
                  children: [
                    Padding(
                      padding: EdgeInsets.only(top: 125, right: 40, left: 40),
                      child: Text(
                        // "ই এপর মালিকানা খালি নাহিয়ান ভাইর।",
                        // style: TextStyle(
        ...
        appBar: AppBar(
          title: Text("সিলেটের বিখ্যাত পর্যটন স্থান"),
        ),
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(onPressed: (){
            String msg="iiii";
            favourite.data(name.title,Name(title: name.title, img: name.img, description: name.description));
            // audio.load("sada.mp3");
            // audio.play("sada.mp3");
